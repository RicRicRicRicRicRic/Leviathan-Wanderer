...
var room_paths: Array[String] = [
	"res://scene/Chapter1/Level1_roomA.tscn",
	"res://scene/Chapter1/Level1_roomB.tscn",
	"res://scene/Chapter1/Level1_roomC.tscn",
	"res://scene/Chapter1/Level1_roomD.tscn"
]

var final_room_path: String = "res://scene/Chapter1/final_room.tscn"
...
func _on_path_entered(body: Node, direction: String) -> void:
	if not body.is_in_group("player") or room_spawned:
		return
	room_spawned = true
	opened_exit_direction = direction
	spawned_from_bottom = (direction == "bottom")
	call_deferred("handle_initial_blockades", direction)
